...
def main():
    ...
    while whatToDoNext == 0:
        ...
        fdb.writePlayersDB( fdb.pathDB, BdD)
        ...
        if whatToDoNext != 1:
            yesOrNot = f00.chooseLetterMsg('Vols seguir jugant  [s]/[n]?', ['val', 'sn', 'Només s\'accepta  s  o  n'],
                                           ['len', 1, 'L\'entrada ha de 1 unic caracter s o n'])
            if yesOrNot == 'n':
                whatToDoNext = 1
