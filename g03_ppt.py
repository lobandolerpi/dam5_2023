...
def startPPT(playerArg):
    ...
    while endGame == False:
        ...
        print(colored(player, 'green') + ": " + colored(dicPPT[playPlayer], 'yellow') + "  vs  " + colored(
            dicPPT[playCPU], 'yellow') + " :" + colored("CPU", 'red'))
        print("En aquesta ronda has :" + partialResult)
        print("------Resultat-Partida------")
        print(colored(player, 'green') + ":    [ " + colored(str(numberOfVictoriesPlayer),
                                                             'yellow') + " ]  vs  [ " + colored(
            str(numberOfVictoriesCPU), 'yellow') + " ]    :" + colored("CPU", 'red'))
